...
SECRET_KEY = os.getenv('SECRET_KEY') or 'django-insecure--1j@enwddh^0a=r-ix(ihwd1e+e=($=d*p3zk&v7xc=%a-nz6j'
...
# SSL & Reverse Proxy Header Settings
...
DEFAULT_FROM_EMAIL = (os.getenv('DEFAULT_FROM_EMAIL') or '').strip() or 'Box4 <info@box4homes.com>'
